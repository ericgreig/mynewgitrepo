...
<link href="CSS/PHPtable.css" rel="stylesheet" type="text/css">
<noscript>
</noscript>
...
<div class="phptable"> <!-- Player Information !-->
...
while ($row = mysql_fetch_array($result)) {
		    echo "<center>"."<table cellpadding=5 border=1>";  
        echo "<td>"."<center>".$row['id']."<br>".
		"</center>"."</td>"; 
		echo "<td>"."<center>"."<a href='player.php?name=<?php echo urlencode()?>".$row['name']."&amp;id=".$row['id']."'>".$row['name']."<br>".
		"</center>"."</td>"; 
